<%@page import="com.pdfPreview.util.PropertiesUtil"%>
...
//获取文件上传路径
String saveDirectory = PropertiesUtil.getValue("officeview.file.dir");
//每个文件最大50m
int maxPostSize = Integer.parseInt(PropertiesUtil.getValue("officeview.file.maxsize"));
