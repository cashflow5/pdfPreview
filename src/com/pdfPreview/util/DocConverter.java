...
public class DocConverter {
	...
	private File pdfFile; //pdf文件
	private File swfFile; //web展示的swf文件
	private File docFile; //原始文件
	private static String SWFToolsDir; //SWFTools安装目录
	private static String openOfficeIp; //oppenOfice服务
